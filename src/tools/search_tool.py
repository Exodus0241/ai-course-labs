...
class SearchWebTool(BaseTool):
    ...
    def _normalize_href(self, href: str) -> str:
        ...
        if "duckduckgo.com" not in parsed.netloc and not href.startswith("//duckduckgo.com/"):
            return href
    ...
    def _parse_results(self, html: str, num_results: int) -> list[str]:
        ...
        for match in matches:
            ...
            href = self._normalize_href(unescape(match.group("href")))
            parsed.append(f"- {unescape(title)}\n  {href}")
